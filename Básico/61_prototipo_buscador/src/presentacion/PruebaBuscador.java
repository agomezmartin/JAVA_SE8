...
public class PruebaBuscador {
	...
	public static void main(String[] args) {
		...
		List<Item> items=List.of(new Item("www.google.com","varios","es un buscador"),
				new Item("www.fnac.com","libros","libros y más"),
				new Item("www.mybook.com","libros","todos los libros"),
				new Item("www.fm.com","musica","24 horas de múscia"));

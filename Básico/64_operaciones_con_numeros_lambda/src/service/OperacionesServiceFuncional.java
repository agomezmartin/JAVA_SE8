...
public class OperacionesServiceFuncional {
	int suma;
	...
	public int sumaPorCriterio(List<Integer> numeros,Predicate<Integer> criterio) {
		suma=0; //para que la expresión lambda pueda modificar el contenido
				//de la variable, debe tratarse de una variable atributo NO local
		/*for(int num:numeros) {

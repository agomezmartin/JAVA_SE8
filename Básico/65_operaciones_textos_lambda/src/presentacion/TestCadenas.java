...
public class TestCadenas {
	...
	public static void main(String[] args) {
		...
		service.procesarCadenas(nombres, n->System.out.println(n), s->s.length(), s->s.toLowerCase().startsWith("a"));
		...
		service.procesarCadenas(nombres, n->System.out.println(n), s->{
			int total=0;
